...
{
	public partial class FolderSearchRow : ISearchRow
	{
		...
		{
			if (basic is FolderSearchRowBasic)
				this.basic = (FolderSearchRowBasic)basic;
			else
				throw new ArgumentException("Value should be of type FolderSearchRowBasic", "basic");
		}
	}
}
