...
{
	public partial class DepartmentSearchAdvanced : ISearchAdvanced
	{
		...
		{ 
			if (search is DepartmentSearch)
				this.criteria = (DepartmentSearch)search; 
			else
				throw new System.ArgumentException("Parameter should be of type DepartmentSearch", "search");
		}
		...
		public SearchRow GetColumns(bool create)
		{
			...
			{
				this.columns = new DepartmentSearchRow();
			}
			return this.columns;
		}
		...
		{ 
			if (columns is DepartmentSearchRow)
				this.columns = (DepartmentSearchRow)columns; 
			else
				throw new System.ArgumentException("Parameter should be of type DepartmentSearchRow", "columns");
		}
