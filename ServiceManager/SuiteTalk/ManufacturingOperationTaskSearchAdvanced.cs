...
{
	public partial class ManufacturingOperationTaskSearchAdvanced : ISearchAdvanced
	{
		...
		{ 
			if (search is ManufacturingOperationTaskSearch)
				this.criteria = (ManufacturingOperationTaskSearch)search; 
			else
				throw new System.ArgumentException("Parameter should be of type ManufacturingOperationTaskSearch", "search");
		}
		...
		public SearchRow GetColumns(bool create)
		{
			...
			{
				this.columns = new ManufacturingOperationTaskSearchRow();
			}
			return this.columns;
		}
