...
{
	public partial class CustomerSearchRow : ISearchRow
	{
		...
		{
			if (basic is CustomerSearchRowBasic)
				this.basic = (CustomerSearchRowBasic)basic;
			else
				throw new ArgumentException("Value should be of type CustomerSearchRowBasic", "basic");
		}
	}
}
