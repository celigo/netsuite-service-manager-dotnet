...
{
	public partial class CustomListSearchAdvanced : ISearchAdvanced
	{
		...
		{ 
			if (search is CustomListSearch)
				this.criteria = (CustomListSearch)search; 
			else
				throw new System.ArgumentException("Parameter should be of type CustomListSearch", "search");
		}
		...
		public SearchRow GetColumns(bool create)
		{
			...
			{
				this.columns = new CustomListSearchRow();
			}
			return this.columns;
		}
		...
		{ 
			if (columns is CustomListSearchRow)
				this.columns = (CustomListSearchRow)columns; 
			else
				throw new System.ArgumentException("Parameter should be of type CustomListSearchRow", "columns");
		}
