...
{
	public partial class SolutionSearchBasic : ISearchBasic, ISupportsCustomFields<SearchCustomField>	
	{			
		/// <summary>
	...
	public partial class SolutionSearch : ISearchRecord
	{
		/// <summary>
		...
		public ISearchBasic GetSearchBasic(bool create)
		{
			if (create && this.basic == null)
				this.basic = new SolutionSearchBasic();
			return this.basic;
		}
	}
}	
