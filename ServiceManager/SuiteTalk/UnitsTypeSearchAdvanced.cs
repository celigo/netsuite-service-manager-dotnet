...
{
	public partial class UnitsTypeSearchAdvanced : ISearchAdvanced
	{
		...
		{ 
			if (search is UnitsTypeSearch)
				this.criteria = (UnitsTypeSearch)search; 
			else
				throw new System.ArgumentException("Parameter should be of type UnitsTypeSearch", "search");
		}
		...
		public SearchRow GetColumns(bool create)
		{
			...
			{
				this.columns = new UnitsTypeSearchRow();
			}
			return this.columns;
		}
		...
		{ 
			if (columns is UnitsTypeSearchRow)
				this.columns = (UnitsTypeSearchRow)columns; 
			else
				throw new System.ArgumentException("Parameter should be of type UnitsTypeSearchRow", "columns");
		}
