...
{
	public partial class ExpenseCategorySearchRow : ISearchRow
	{
		...
		{
			if (basic is ExpenseCategorySearchRowBasic)
				this.basic = (ExpenseCategorySearchRowBasic)basic;
			else
				throw new ArgumentException("Value should be of type ExpenseCategorySearchRowBasic", "basic");
		}
	}
}
