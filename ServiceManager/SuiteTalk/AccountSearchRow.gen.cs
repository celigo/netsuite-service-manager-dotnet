...
{
	public partial class AccountSearchRow : ISearchRow
	{
		...
		{
			if (basic is AccountSearchRowBasic)
				this.basic = (AccountSearchRowBasic)basic;
			else
				throw new ArgumentException("Value should be of type AccountSearchRowBasic", "basic");
		}
	}
}
