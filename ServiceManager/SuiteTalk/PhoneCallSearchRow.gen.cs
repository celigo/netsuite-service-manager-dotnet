...
{
	public partial class PhoneCallSearchRow : ISearchRow
	{
		...
		{
			if (basic is PhoneCallSearchRowBasic)
				this.basic = (PhoneCallSearchRowBasic)basic;
			else
				throw new ArgumentException("Value should be of type PhoneCallSearchRowBasic", "basic");
		}
	}
}
