...
{
	public partial class VendorSearchRow : ISearchRow
	{
		...
		{
			if (basic is VendorSearchRowBasic)
				this.basic = (VendorSearchRowBasic)basic;
			else
				throw new ArgumentException("Value should be of type VendorSearchRowBasic", "basic");
		}
	}
}
