...
{
	public partial class CustomerStatusSearchBasic : ISearchBasic	
	{	}

	public partial class CustomerStatusSearch : ISearchRecord
	{
		/// <summary>
		...
		public ISearchBasic GetSearchBasic(bool create)
		{
			if (create && this.basic == null)
				this.basic = new CustomerStatusSearchBasic();
			return this.basic;
		}
	}
}	
