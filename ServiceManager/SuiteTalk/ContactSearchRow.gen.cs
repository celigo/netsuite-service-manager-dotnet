...
{
	public partial class ContactSearchRow : ISearchRow
	{
		...
		{
			if (basic is ContactSearchRowBasic)
				this.basic = (ContactSearchRowBasic)basic;
			else
				throw new ArgumentException("Value should be of type ContactSearchRowBasic", "basic");
		}
	}
}
