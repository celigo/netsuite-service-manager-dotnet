...
{
	public partial class NoteSearchRow : ISearchRow
	{
		...
		{
			if (basic is NoteSearchRowBasic)
				this.basic = (NoteSearchRowBasic)basic;
			else
				throw new ArgumentException("Value should be of type NoteSearchRowBasic", "basic");
		}
	}
}
