...
{
	public partial class PayrollItemSearchRow : ISearchRow
	{
		...
		{
			if (basic is PayrollItemSearchRowBasic)
				this.basic = (PayrollItemSearchRowBasic)basic;
			else
				throw new ArgumentException("Value should be of type PayrollItemSearchRowBasic", "basic");
		}
	}
}
