...
{
	public partial class JobStatusSearchRow : ISearchRow
	{
		...
		{
			if (basic is JobStatusSearchRowBasic)
				this.basic = (JobStatusSearchRowBasic)basic;
			else
				throw new ArgumentException("Value should be of type JobStatusSearchRowBasic", "basic");
		}
	}
}
