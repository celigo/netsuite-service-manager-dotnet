...
{
	public partial class AccountSearchAdvanced : ISearchAdvanced
	{
		...
		{ 
			if (search is AccountSearch)
				this.criteria = (AccountSearch)search; 
			else
				throw new System.ArgumentException("Parameter should be of type AccountSearch", "search");
		}
		...
		public SearchRow GetColumns(bool create)
		{
			...
			{
				this.columns = new AccountSearchRow();
			}
			return this.columns;
		}
