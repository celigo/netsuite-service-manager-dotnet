...
{
	public partial class OpportunitySearchRow : ISearchRow
	{
		...
		{
			if (basic is OpportunitySearchRowBasic)
				this.basic = (OpportunitySearchRowBasic)basic;
			else
				throw new ArgumentException("Value should be of type OpportunitySearchRowBasic", "basic");
		}
	}
}
