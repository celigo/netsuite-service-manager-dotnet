...
{
	public partial class ResourceAllocationSearchBasic : ISearchBasic, ISupportsCustomFields<SearchCustomField>	
	{			
		/// <summary>
	...
	public partial class ResourceAllocationSearch : ISearchRecord
	{
		/// <summary>
		...
		public ISearchBasic GetSearchBasic(bool create)
		{
			if (create && this.basic == null)
				this.basic = new ResourceAllocationSearchBasic();
			return this.basic;
		}
	}
}	
