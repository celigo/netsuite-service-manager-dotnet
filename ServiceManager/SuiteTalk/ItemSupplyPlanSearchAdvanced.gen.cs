...
{
	public partial class ItemSupplyPlanSearchAdvanced : ISearchAdvanced
	{
		...
		{ 
			if (search is ItemSupplyPlanSearch)
				this.criteria = (ItemSupplyPlanSearch)search; 
			else
				throw new System.ArgumentException("Parameter should be of type ItemSupplyPlanSearch", "search");
		}
		...
		public SearchRow GetColumns(bool create)
		{
			...
			{
				this.columns = new ItemSupplyPlanSearchRow();
			}
			return this.columns;
		}
		...
		{ 
			if (columns is ItemSupplyPlanSearchRow)
				this.columns = (ItemSupplyPlanSearchRow)columns; 
			else
				throw new System.ArgumentException("Parameter should be of type ItemSupplyPlanSearchRow", "columns");
		}
