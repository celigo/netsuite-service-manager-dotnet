...
{
	public partial class PartnerSearchRow : ISearchRow
	{
		...
		{
			if (basic is PartnerSearchRowBasic)
				this.basic = (PartnerSearchRowBasic)basic;
			else
				throw new ArgumentException("Value should be of type PartnerSearchRowBasic", "basic");
		}
	}
}
