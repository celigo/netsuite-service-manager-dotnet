...
{
	public partial class AccountingPeriodSearchBasic : ISearchBasic	
	{	}

	public partial class AccountingPeriodSearch : ISearchRecord
	{
		/// <summary>
		...
		public ISearchBasic GetSearchBasic(bool create)
		{
			if (create && this.basic == null)
				this.basic = new AccountingPeriodSearchBasic();
			return this.basic;
		}
	}
}	
