...
{
	public partial class BillingAccountSearchAdvanced : ISearchAdvanced
	{
		...
		{ 
			if (search is BillingAccountSearch)
				this.criteria = (BillingAccountSearch)search; 
			else
				throw new System.ArgumentException("Parameter should be of type BillingAccountSearch", "search");
		}
		...
		public SearchRow GetColumns(bool create)
		{
			...
			{
				this.columns = new BillingAccountSearchRow();
			}
			return this.columns;
		}
		...
		{ 
			if (columns is BillingAccountSearchRow)
				this.columns = (BillingAccountSearchRow)columns; 
			else
				throw new System.ArgumentException("Parameter should be of type BillingAccountSearchRow", "columns");
		}
