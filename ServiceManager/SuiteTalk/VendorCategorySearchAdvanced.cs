...
{
	public partial class VendorCategorySearchAdvanced : ISearchAdvanced
	{
		...
		{ 
			if (search is VendorCategorySearch)
				this.criteria = (VendorCategorySearch)search; 
			else
				throw new System.ArgumentException("Parameter should be of type VendorCategorySearch", "search");
		}
		...
		public SearchRow GetColumns(bool create)
		{
			...
			{
				this.columns = new VendorCategorySearchRow();
			}
			return this.columns;
		}
		...
		{ 
			if (columns is VendorCategorySearchRow)
				this.columns = (VendorCategorySearchRow)columns; 
			else
				throw new System.ArgumentException("Parameter should be of type VendorCategorySearchRow", "columns");
		}
