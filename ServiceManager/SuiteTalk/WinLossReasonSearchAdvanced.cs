...
{
	public partial class WinLossReasonSearchAdvanced : ISearchAdvanced
	{
		...
		{ 
			if (search is WinLossReasonSearch)
				this.criteria = (WinLossReasonSearch)search; 
			else
				throw new System.ArgumentException("Parameter should be of type WinLossReasonSearch", "search");
		}
		...
		public SearchRow GetColumns(bool create)
		{
			...
			{
				this.columns = new WinLossReasonSearchRow();
			}
			return this.columns;
		}
