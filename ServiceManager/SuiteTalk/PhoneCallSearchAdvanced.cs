...
{
	public partial class PhoneCallSearchAdvanced : ISearchAdvanced
	{
		...
		{ 
			if (search is PhoneCallSearch)
				this.criteria = (PhoneCallSearch)search; 
			else
				throw new System.ArgumentException("Parameter should be of type PhoneCallSearch", "search");
		}
		...
		public SearchRow GetColumns(bool create)
		{
			...
			{
				this.columns = new PhoneCallSearchRow();
			}
			return this.columns;
		}
		...
		{ 
			if (columns is PhoneCallSearchRow)
				this.columns = (PhoneCallSearchRow)columns; 
			else
				throw new System.ArgumentException("Parameter should be of type PhoneCallSearchRow", "columns");
		}
