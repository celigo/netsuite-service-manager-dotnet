...
{
	public partial class AccountingTransactionSearchRow : ISearchRow
	{
		...
		{
			if (basic is AccountingTransactionSearchRowBasic)
				this.basic = (AccountingTransactionSearchRowBasic)basic;
			else
				throw new ArgumentException("Value should be of type AccountingTransactionSearchRowBasic", "basic");
		}
	}
}
