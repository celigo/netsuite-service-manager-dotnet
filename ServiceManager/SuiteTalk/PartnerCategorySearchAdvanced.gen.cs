...
{
	public partial class PartnerCategorySearchAdvanced : ISearchAdvanced
	{
		...
		{ 
			if (search is PartnerCategorySearch)
				this.criteria = (PartnerCategorySearch)search; 
			else
				throw new System.ArgumentException("Parameter should be of type PartnerCategorySearch", "search");
		}
		...
		public SearchRow GetColumns(bool create)
		{
			...
			{
				this.columns = new PartnerCategorySearchRow();
			}
			return this.columns;
		}
		...
		{ 
			if (columns is PartnerCategorySearchRow)
				this.columns = (PartnerCategorySearchRow)columns; 
			else
				throw new System.ArgumentException("Parameter should be of type PartnerCategorySearchRow", "columns");
		}
