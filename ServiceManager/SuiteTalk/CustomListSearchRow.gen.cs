...
{
	public partial class CustomListSearchRow : ISearchRow
	{
		...
		{
			if (basic is CustomListSearchRowBasic)
				this.basic = (CustomListSearchRowBasic)basic;
			else
				throw new ArgumentException("Value should be of type CustomListSearchRowBasic", "basic");
		}
	}
}
