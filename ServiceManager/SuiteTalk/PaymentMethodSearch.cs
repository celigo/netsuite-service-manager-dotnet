...
{
	public partial class PaymentMethodSearchBasic : ISearchBasic	
	{	}

	public partial class PaymentMethodSearch : ISearchRecord
	{
		/// <summary>
		...
		public ISearchBasic GetSearchBasic(bool create)
		{
			if (create && this.basic == null)
				this.basic = new PaymentMethodSearchBasic();
			return this.basic;
		}
	}
}	
