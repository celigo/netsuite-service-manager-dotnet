...
{
	public partial class NoteSearchAdvanced : ISearchAdvanced
	{
		...
		{ 
			if (search is NoteSearch)
				this.criteria = (NoteSearch)search; 
			else
				throw new System.ArgumentException("Parameter should be of type NoteSearch", "search");
		}
		...
		public SearchRow GetColumns(bool create)
		{
			...
			{
				this.columns = new NoteSearchRow();
			}
			return this.columns;
		}
		...
		{ 
			if (columns is NoteSearchRow)
				this.columns = (NoteSearchRow)columns; 
			else
				throw new System.ArgumentException("Parameter should be of type NoteSearchRow", "columns");
		}
