...
{
	public partial class PromotionCodeSearchBasic : ISearchBasic, ISupportsCustomFields<SearchCustomField>	
	{			
		/// <summary>
	...
	public partial class PromotionCodeSearch : ISearchRecord
	{
		/// <summary>
		...
		public ISearchBasic GetSearchBasic(bool create)
		{
			if (create && this.basic == null)
				this.basic = new PromotionCodeSearchBasic();
			return this.basic;
		}
	}
}	
