...
{
	public partial class TransactionSearchRow : ISearchRow
	{
		...
		{
			if (basic is TransactionSearchRowBasic)
				this.basic = (TransactionSearchRowBasic)basic;
			else
				throw new ArgumentException("Value should be of type TransactionSearchRowBasic", "basic");
		}
	}
}
