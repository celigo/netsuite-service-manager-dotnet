...
{
	public partial class ManufacturingCostTemplateSearchAdvanced : ISearchAdvanced
	{
		...
		public SearchRow GetColumns(bool create)
		{
			...
			{
				this.columns = new ManufacturingCostTemplateSearchRow();
			}
			return this.columns;
		}
		...
		{ 
			if (columns is ManufacturingCostTemplateSearchRow)
				this.columns = (ManufacturingCostTemplateSearchRow)columns; 
			else
				throw new System.ArgumentException("Parameter should be of type ManufacturingCostTemplateSearchRow", "columns");
		}
