...
{
	public partial class ContactCategorySearchAdvanced : ISearchAdvanced
	{
		...
		{ 
			if (search is ContactCategorySearch)
				this.criteria = (ContactCategorySearch)search; 
			else
				throw new System.ArgumentException("Parameter should be of type ContactCategorySearch", "search");
		}
		...
		public SearchRow GetColumns(bool create)
		{
			...
			{
				this.columns = new ContactCategorySearchRow();
			}
			return this.columns;
		}
		...
		{ 
			if (columns is ContactCategorySearchRow)
				this.columns = (ContactCategorySearchRow)columns; 
			else
				throw new System.ArgumentException("Parameter should be of type ContactCategorySearchRow", "columns");
		}
