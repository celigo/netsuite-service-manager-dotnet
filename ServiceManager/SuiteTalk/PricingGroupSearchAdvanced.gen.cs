...
{
	public partial class PricingGroupSearchAdvanced : ISearchAdvanced
	{
		...
		{ 
			if (search is PricingGroupSearch)
				this.criteria = (PricingGroupSearch)search; 
			else
				throw new System.ArgumentException("Parameter should be of type PricingGroupSearch", "search");
		}
		...
		public SearchRow GetColumns(bool create)
		{
			...
			{
				this.columns = new PricingGroupSearchRow();
			}
			return this.columns;
		}
		...
		{ 
			if (columns is PricingGroupSearchRow)
				this.columns = (PricingGroupSearchRow)columns; 
			else
				throw new System.ArgumentException("Parameter should be of type PricingGroupSearchRow", "columns");
		}
