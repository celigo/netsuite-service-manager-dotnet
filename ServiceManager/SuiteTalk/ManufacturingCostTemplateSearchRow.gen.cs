...
{
	public partial class ManufacturingCostTemplateSearchRow : ISearchRow
	{
		...
		{
			if (basic is ManufacturingCostTemplateSearchRowBasic)
				this.basic = (ManufacturingCostTemplateSearchRowBasic)basic;
			else
				throw new ArgumentException("Value should be of type ManufacturingCostTemplateSearchRowBasic", "basic");
		}
	}
}
