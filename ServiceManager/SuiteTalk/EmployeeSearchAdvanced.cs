...
{
	public partial class EmployeeSearchAdvanced : ISearchAdvanced
	{
		...
		{ 
			if (search is EmployeeSearch)
				this.criteria = (EmployeeSearch)search; 
			else
				throw new System.ArgumentException("Parameter should be of type EmployeeSearch", "search");
		}
		...
		public SearchRow GetColumns(bool create)
		{
			...
			{
				this.columns = new EmployeeSearchRow();
			}
			return this.columns;
		}
		...
		{ 
			if (columns is EmployeeSearchRow)
				this.columns = (EmployeeSearchRow)columns; 
			else
				throw new System.ArgumentException("Parameter should be of type EmployeeSearchRow", "columns");
		}
