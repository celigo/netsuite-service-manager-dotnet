...
{
	public partial class WinLossReasonSearchRow : ISearchRow
	{
		...
		{
			if (basic is WinLossReasonSearchRowBasic)
				this.basic = (WinLossReasonSearchRowBasic)basic;
			else
				throw new ArgumentException("Value should be of type WinLossReasonSearchRowBasic", "basic");
		}
	}
}
