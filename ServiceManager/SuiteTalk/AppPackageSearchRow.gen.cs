...
{
	public partial class AppPackageSearchRow : ISearchRow
	{
		...
		{
			if (basic is AppPackageSearchRowBasic)
				this.basic = (AppPackageSearchRowBasic)basic;
			else
				throw new ArgumentException("Value should be of type AppPackageSearchRowBasic", "basic");
		}
	}
}
