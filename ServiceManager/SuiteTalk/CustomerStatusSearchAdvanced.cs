...
{
	public partial class CustomerStatusSearchAdvanced : ISearchAdvanced
	{
		...
		{ 
			if (search is CustomerStatusSearch)
				this.criteria = (CustomerStatusSearch)search; 
			else
				throw new System.ArgumentException("Parameter should be of type CustomerStatusSearch", "search");
		}
		...
		public SearchRow GetColumns(bool create)
		{
			...
			{
				this.columns = new CustomerStatusSearchRow();
			}
			return this.columns;
		}
		...
		{ 
			if (columns is CustomerStatusSearchRow)
				this.columns = (CustomerStatusSearchRow)columns; 
			else
				throw new System.ArgumentException("Parameter should be of type CustomerStatusSearchRow", "columns");
		}
