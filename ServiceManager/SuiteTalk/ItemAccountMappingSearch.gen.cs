...
{
	public partial class ItemAccountMappingSearchBasic : ISearchBasic, ISupportsCustomFields<SearchCustomField>	
	{			
		/// <summary>
	...
	public partial class ItemAccountMappingSearch : ISearchRecord
	{
		/// <summary>
		...
		public ISearchBasic GetSearchBasic(bool create)
		{
			if (create && this.basic == null)
				this.basic = new ItemAccountMappingSearchBasic();
			return this.basic;
		}
	}
}	
