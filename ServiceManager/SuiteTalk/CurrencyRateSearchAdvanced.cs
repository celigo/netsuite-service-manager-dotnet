...
{
	public partial class CurrencyRateSearchAdvanced : ISearchAdvanced
	{
		...
		{ 
			if (search is CurrencyRateSearch)
				this.criteria = (CurrencyRateSearch)search; 
			else
				throw new System.ArgumentException("Parameter should be of type CurrencyRateSearch", "search");
		}
		...
		public SearchRow GetColumns(bool create)
		{
			...
			{
				this.columns = new CurrencyRateSearchRow();
			}
			return this.columns;
		}
		...
		{ 
			if (columns is CurrencyRateSearchRow)
				this.columns = (CurrencyRateSearchRow)columns; 
			else
				throw new System.ArgumentException("Parameter should be of type CurrencyRateSearchRow", "columns");
		}
