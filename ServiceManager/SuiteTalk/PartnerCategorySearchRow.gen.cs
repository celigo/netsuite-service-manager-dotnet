...
{
	public partial class PartnerCategorySearchRow : ISearchRow
	{
		...
		{
			if (basic is PartnerCategorySearchRowBasic)
				this.basic = (PartnerCategorySearchRowBasic)basic;
			else
				throw new ArgumentException("Value should be of type PartnerCategorySearchRowBasic", "basic");
		}
	}
}
