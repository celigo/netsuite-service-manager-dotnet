...
{
	public partial class JobTypeSearchAdvanced : ISearchAdvanced
	{
		...
		{ 
			if (search is JobTypeSearch)
				this.criteria = (JobTypeSearch)search; 
			else
				throw new System.ArgumentException("Parameter should be of type JobTypeSearch", "search");
		}
		...
		public SearchRow GetColumns(bool create)
		{
			...
			{
				this.columns = new JobTypeSearchRow();
			}
			return this.columns;
		}
		...
		{ 
			if (columns is JobTypeSearchRow)
				this.columns = (JobTypeSearchRow)columns; 
			else
				throw new System.ArgumentException("Parameter should be of type JobTypeSearchRow", "columns");
		}
