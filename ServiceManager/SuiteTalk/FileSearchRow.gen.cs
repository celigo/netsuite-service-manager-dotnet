...
{
	public partial class FileSearchRow : ISearchRow
	{
		...
		{
			if (basic is FileSearchRowBasic)
				this.basic = (FileSearchRowBasic)basic;
			else
				throw new ArgumentException("Value should be of type FileSearchRowBasic", "basic");
		}
	}
}
