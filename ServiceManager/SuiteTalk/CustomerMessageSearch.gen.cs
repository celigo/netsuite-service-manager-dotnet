...
{
	public partial class CustomerMessageSearchBasic : ISearchBasic	
	{	}

	public partial class CustomerMessageSearch : ISearchRecord
	{
		/// <summary>
		...
		public ISearchBasic GetSearchBasic(bool create)
		{
			if (create && this.basic == null)
				this.basic = new CustomerMessageSearchBasic();
			return this.basic;
		}
	}
}	
