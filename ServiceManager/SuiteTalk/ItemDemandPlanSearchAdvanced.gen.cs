...
{
	public partial class ItemDemandPlanSearchAdvanced : ISearchAdvanced
	{
		...
		{ 
			if (search is ItemDemandPlanSearch)
				this.criteria = (ItemDemandPlanSearch)search; 
			else
				throw new System.ArgumentException("Parameter should be of type ItemDemandPlanSearch", "search");
		}
		...
		public SearchRow GetColumns(bool create)
		{
			...
			{
				this.columns = new ItemDemandPlanSearchRow();
			}
			return this.columns;
		}
		...
		{ 
			if (columns is ItemDemandPlanSearchRow)
				this.columns = (ItemDemandPlanSearchRow)columns; 
			else
				throw new System.ArgumentException("Parameter should be of type ItemDemandPlanSearchRow", "columns");
		}
