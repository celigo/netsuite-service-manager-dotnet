...
{
	public partial class CurrencyRateSearchRow : ISearchRow
	{
		...
		{
			if (basic is CurrencyRateSearchRowBasic)
				this.basic = (CurrencyRateSearchRowBasic)basic;
			else
				throw new ArgumentException("Value should be of type CurrencyRateSearchRowBasic", "basic");
		}
	}
}
