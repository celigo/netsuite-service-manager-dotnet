...
{
	public partial class SubsidiarySearchAdvanced : ISearchAdvanced
	{
		...
		{ 
			if (search is SubsidiarySearch)
				this.criteria = (SubsidiarySearch)search; 
			else
				throw new System.ArgumentException("Parameter should be of type SubsidiarySearch", "search");
		}
		...
		public SearchRow GetColumns(bool create)
		{
			...
			{
				this.columns = new SubsidiarySearchRow();
			}
			return this.columns;
		}
		...
		{ 
			if (columns is SubsidiarySearchRow)
				this.columns = (SubsidiarySearchRow)columns; 
			else
				throw new System.ArgumentException("Parameter should be of type SubsidiarySearchRow", "columns");
		}
