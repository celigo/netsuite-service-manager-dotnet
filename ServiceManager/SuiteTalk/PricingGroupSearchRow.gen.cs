...
{
	public partial class PricingGroupSearchRow : ISearchRow
	{
		...
		{
			if (basic is PricingGroupSearchRowBasic)
				this.basic = (PricingGroupSearchRowBasic)basic;
			else
				throw new ArgumentException("Value should be of type PricingGroupSearchRowBasic", "basic");
		}
	}
}
