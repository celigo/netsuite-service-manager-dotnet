...
{
	public partial class VendorCategorySearchRow : ISearchRow
	{
		...
		{
			if (basic is VendorCategorySearchRowBasic)
				this.basic = (VendorCategorySearchRowBasic)basic;
			else
				throw new ArgumentException("Value should be of type VendorCategorySearchRowBasic", "basic");
		}
	}
}
