...
{
	public partial class ManufacturingRoutingSearchRow : ISearchRow
	{
		...
		{
			if (basic is ManufacturingRoutingSearchRowBasic)
				this.basic = (ManufacturingRoutingSearchRowBasic)basic;
			else
				throw new ArgumentException("Value should be of type ManufacturingRoutingSearchRowBasic", "basic");
		}
	}
}
