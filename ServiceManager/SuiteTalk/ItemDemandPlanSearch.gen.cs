...
{
	public partial class ItemDemandPlanSearchBasic : ISearchBasic, ISupportsCustomFields<SearchCustomField>	
	{			
		/// <summary>
	...
	public partial class ItemDemandPlanSearch : ISearchRecord
	{
		/// <summary>
		...
		public ISearchBasic GetSearchBasic(bool create)
		{
			if (create && this.basic == null)
				this.basic = new ItemDemandPlanSearchBasic();
			return this.basic;
		}
	}
}	
