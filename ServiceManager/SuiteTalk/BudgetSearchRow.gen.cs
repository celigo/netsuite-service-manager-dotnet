...
{
	public partial class BudgetSearchRow : ISearchRow
	{
		...
		{
			if (basic is BudgetSearchRowBasic)
				this.basic = (BudgetSearchRowBasic)basic;
			else
				throw new ArgumentException("Value should be of type BudgetSearchRowBasic", "basic");
		}
	}
}
