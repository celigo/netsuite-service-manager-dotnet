...
{
	public partial class SupportCaseSearchRow : ISearchRow
	{
		...
		{
			if (basic is SupportCaseSearchRowBasic)
				this.basic = (SupportCaseSearchRowBasic)basic;
			else
				throw new ArgumentException("Value should be of type SupportCaseSearchRowBasic", "basic");
		}
	}
}
