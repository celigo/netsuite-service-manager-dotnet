...
{
	public partial class JobSearchRow : ISearchRow
	{
		...
		{
			if (basic is JobSearchRowBasic)
				this.basic = (JobSearchRowBasic)basic;
			else
				throw new ArgumentException("Value should be of type JobSearchRowBasic", "basic");
		}
	}
}
