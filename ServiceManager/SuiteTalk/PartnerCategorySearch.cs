...
{
	public partial class PartnerCategorySearchBasic : ISearchBasic	
	{	}

	public partial class PartnerCategorySearch : ISearchRecord
	{
		/// <summary>
		...
		public ISearchBasic GetSearchBasic(bool create)
		{
			if (create && this.basic == null)
				this.basic = new PartnerCategorySearchBasic();
			return this.basic;
		}
	}
}	
