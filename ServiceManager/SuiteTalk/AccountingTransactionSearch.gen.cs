...
{
	public partial class AccountingTransactionSearchBasic : ISearchBasic	
	{	}

	public partial class AccountingTransactionSearch : ISearchRecord
	{
		/// <summary>
		...
		public ISearchBasic GetSearchBasic(bool create)
		{
			if (create && this.basic == null)
				this.basic = new AccountingTransactionSearchBasic();
			return this.basic;
		}
	}
}	
