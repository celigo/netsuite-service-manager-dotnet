...
{
	public partial class OtherNameCategorySearchAdvanced : ISearchAdvanced
	{
		...
		{ 
			if (search is OtherNameCategorySearch)
				this.criteria = (OtherNameCategorySearch)search; 
			else
				throw new System.ArgumentException("Parameter should be of type OtherNameCategorySearch", "search");
		}
		...
		public SearchRow GetColumns(bool create)
		{
			...
			{
				this.columns = new OtherNameCategorySearchRow();
			}
			return this.columns;
		}
		...
		{ 
			if (columns is OtherNameCategorySearchRow)
				this.columns = (OtherNameCategorySearchRow)columns; 
			else
				throw new System.ArgumentException("Parameter should be of type OtherNameCategorySearchRow", "columns");
		}
