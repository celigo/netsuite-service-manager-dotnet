...
{
	public partial class AccountingTransactionSearchAdvanced : ISearchAdvanced
	{
		...
		{ 
			if (search is AccountingTransactionSearch)
				this.criteria = (AccountingTransactionSearch)search; 
			else
				throw new System.ArgumentException("Parameter should be of type AccountingTransactionSearch", "search");
		}
		...
		public SearchRow GetColumns(bool create)
		{
			...
			{
				this.columns = new AccountingTransactionSearchRow();
			}
			return this.columns;
		}
		...
		{ 
			if (columns is AccountingTransactionSearchRow)
				this.columns = (AccountingTransactionSearchRow)columns; 
			else
				throw new System.ArgumentException("Parameter should be of type AccountingTransactionSearchRow", "columns");
		}
