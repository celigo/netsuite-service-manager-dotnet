...
{
	public partial class SalesRoleSearchAdvanced : ISearchAdvanced
	{
		...
		{ 
			if (search is SalesRoleSearch)
				this.criteria = (SalesRoleSearch)search; 
			else
				throw new System.ArgumentException("Parameter should be of type SalesRoleSearch", "search");
		}
		...
		public SearchRow GetColumns(bool create)
		{
			...
			{
				this.columns = new SalesRoleSearchRow();
			}
			return this.columns;
		}
		...
		{ 
			if (columns is SalesRoleSearchRow)
				this.columns = (SalesRoleSearchRow)columns; 
			else
				throw new System.ArgumentException("Parameter should be of type SalesRoleSearchRow", "columns");
		}
