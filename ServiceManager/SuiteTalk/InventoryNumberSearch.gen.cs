...
{
	public partial class InventoryNumberSearchBasic : ISearchBasic, ISupportsCustomFields<SearchCustomField>	
	{			
		/// <summary>
	...
	public partial class InventoryNumberSearch : ISearchRecord
	{
		/// <summary>
		...
		public ISearchBasic GetSearchBasic(bool create)
		{
			if (create && this.basic == null)
				this.basic = new InventoryNumberSearchBasic();
			return this.basic;
		}
	}
}	
