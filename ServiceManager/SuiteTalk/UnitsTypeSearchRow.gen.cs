...
{
	public partial class UnitsTypeSearchRow : ISearchRow
	{
		...
		{
			if (basic is UnitsTypeSearchRowBasic)
				this.basic = (UnitsTypeSearchRowBasic)basic;
			else
				throw new ArgumentException("Value should be of type UnitsTypeSearchRowBasic", "basic");
		}
	}
}
