...
{
	public partial class PartnerSearchAdvanced : ISearchAdvanced
	{
		...
		{ 
			if (search is PartnerSearch)
				this.criteria = (PartnerSearch)search; 
			else
				throw new System.ArgumentException("Parameter should be of type PartnerSearch", "search");
		}
		...
		public SearchRow GetColumns(bool create)
		{
			...
			{
				this.columns = new PartnerSearchRow();
			}
			return this.columns;
		}
		...
		{ 
			if (columns is PartnerSearchRow)
				this.columns = (PartnerSearchRow)columns; 
			else
				throw new System.ArgumentException("Parameter should be of type PartnerSearchRow", "columns");
		}
