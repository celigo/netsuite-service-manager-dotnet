...
{
	public partial class ItemSearchRow : ISearchRow
	{
		...
		{
			if (basic is ItemSearchRowBasic)
				this.basic = (ItemSearchRowBasic)basic;
			else
				throw new ArgumentException("Value should be of type ItemSearchRowBasic", "basic");
		}
	}
}
