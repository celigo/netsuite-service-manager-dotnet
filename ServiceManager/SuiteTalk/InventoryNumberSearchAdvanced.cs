...
{
	public partial class InventoryNumberSearchAdvanced : ISearchAdvanced
	{
		...
		{ 
			if (search is InventoryNumberSearch)
				this.criteria = (InventoryNumberSearch)search; 
			else
				throw new System.ArgumentException("Parameter should be of type InventoryNumberSearch", "search");
		}
		...
		public SearchRow GetColumns(bool create)
		{
			...
			{
				this.columns = new InventoryNumberSearchRow();
			}
			return this.columns;
		}
