...
{
	public partial class ResourceAllocationSearchAdvanced : ISearchAdvanced
	{
		...
		{ 
			if (search is ResourceAllocationSearch)
				this.criteria = (ResourceAllocationSearch)search; 
			else
				throw new System.ArgumentException("Parameter should be of type ResourceAllocationSearch", "search");
		}
		...
		public SearchRow GetColumns(bool create)
		{
			...
			{
				this.columns = new ResourceAllocationSearchRow();
			}
			return this.columns;
		}
		...
		{ 
			if (columns is ResourceAllocationSearchRow)
				this.columns = (ResourceAllocationSearchRow)columns; 
			else
				throw new System.ArgumentException("Parameter should be of type ResourceAllocationSearchRow", "columns");
		}
