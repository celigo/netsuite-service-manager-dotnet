...
{
	public partial class TimeEntrySearchAdvanced : ISearchAdvanced
	{
		...
		{ 
			if (search is TimeEntrySearch)
				this.criteria = (TimeEntrySearch)search; 
			else
				throw new System.ArgumentException("Parameter should be of type TimeEntrySearch", "search");
		}
		...
		public SearchRow GetColumns(bool create)
		{
			...
			{
				this.columns = new TimeEntrySearchRow();
			}
			return this.columns;
		}
		...
		{ 
			if (columns is TimeEntrySearchRow)
				this.columns = (TimeEntrySearchRow)columns; 
			else
				throw new System.ArgumentException("Parameter should be of type TimeEntrySearchRow", "columns");
		}
