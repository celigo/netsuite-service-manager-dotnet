...
{
	public partial class AccountingPeriodSearchAdvanced : ISearchAdvanced
	{
		...
		public SearchRow GetColumns(bool create)
		{
			...
			{
				this.columns = new AccountingPeriodSearchRow();
			}
			return this.columns;
		}
		...
		{ 
			if (columns is AccountingPeriodSearchRow)
				this.columns = (AccountingPeriodSearchRow)columns; 
			else
				throw new System.ArgumentException("Parameter should be of type AccountingPeriodSearchRow", "columns");
		}
