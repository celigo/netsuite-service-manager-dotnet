...
{
	public partial class GiftCertificateSearchAdvanced : ISearchAdvanced
	{
		...
		{ 
			if (search is GiftCertificateSearch)
				this.criteria = (GiftCertificateSearch)search; 
			else
				throw new System.ArgumentException("Parameter should be of type GiftCertificateSearch", "search");
		}
		...
		public SearchRow GetColumns(bool create)
		{
			...
			{
				this.columns = new GiftCertificateSearchRow();
			}
			return this.columns;
		}
