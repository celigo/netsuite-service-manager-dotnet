...
{
	public partial class TransactionSearchAdvanced : ISearchAdvanced
	{
		...
		{ 
			if (search is TransactionSearch)
				this.criteria = (TransactionSearch)search; 
			else
				throw new System.ArgumentException("Parameter should be of type TransactionSearch", "search");
		}
		...
		public SearchRow GetColumns(bool create)
		{
			...
			{
				this.columns = new TransactionSearchRow();
			}
			return this.columns;
		}
		...
		{ 
			if (columns is TransactionSearchRow)
				this.columns = (TransactionSearchRow)columns; 
			else
				throw new System.ArgumentException("Parameter should be of type TransactionSearchRow", "columns");
		}
