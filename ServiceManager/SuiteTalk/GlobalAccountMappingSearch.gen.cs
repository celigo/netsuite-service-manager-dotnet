...
{
	public partial class GlobalAccountMappingSearchBasic : ISearchBasic, ISupportsCustomFields<SearchCustomField>	
	{			
		/// <summary>
	...
	public partial class GlobalAccountMappingSearch : ISearchRecord
	{
		/// <summary>
		...
		public ISearchBasic GetSearchBasic(bool create)
		{
			if (create && this.basic == null)
				this.basic = new GlobalAccountMappingSearchBasic();
			return this.basic;
		}
	}
}	
