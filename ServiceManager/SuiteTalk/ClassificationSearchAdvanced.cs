...
{
	public partial class ClassificationSearchAdvanced : ISearchAdvanced
	{
		...
		{ 
			if (search is ClassificationSearch)
				this.criteria = (ClassificationSearch)search; 
			else
				throw new System.ArgumentException("Parameter should be of type ClassificationSearch", "search");
		}
		...
		public SearchRow GetColumns(bool create)
		{
			...
			{
				this.columns = new ClassificationSearchRow();
			}
			return this.columns;
		}
		...
		{ 
			if (columns is ClassificationSearchRow)
				this.columns = (ClassificationSearchRow)columns; 
			else
				throw new System.ArgumentException("Parameter should be of type ClassificationSearchRow", "columns");
		}
