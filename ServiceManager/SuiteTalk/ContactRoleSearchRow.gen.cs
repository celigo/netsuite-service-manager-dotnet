...
{
	public partial class ContactRoleSearchRow : ISearchRow
	{
		...
		{
			if (basic is ContactRoleSearchRowBasic)
				this.basic = (ContactRoleSearchRowBasic)basic;
			else
				throw new ArgumentException("Value should be of type ContactRoleSearchRowBasic", "basic");
		}
	}
}
