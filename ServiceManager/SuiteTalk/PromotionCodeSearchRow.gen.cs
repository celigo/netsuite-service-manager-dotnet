...
{
	public partial class PromotionCodeSearchRow : ISearchRow
	{
		...
		{
			if (basic is PromotionCodeSearchRowBasic)
				this.basic = (PromotionCodeSearchRowBasic)basic;
			else
				throw new ArgumentException("Value should be of type PromotionCodeSearchRowBasic", "basic");
		}
	}
}
