...
{
	public partial class ItemAccountMappingSearchRow : ISearchRow
	{
		...
		{
			if (basic is ItemAccountMappingSearchRowBasic)
				this.basic = (ItemAccountMappingSearchRowBasic)basic;
			else
				throw new ArgumentException("Value should be of type ItemAccountMappingSearchRowBasic", "basic");
		}
	}
}
