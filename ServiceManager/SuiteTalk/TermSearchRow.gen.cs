...
{
	public partial class TermSearchRow : ISearchRow
	{
		...
		{
			if (basic is TermSearchRowBasic)
				this.basic = (TermSearchRowBasic)basic;
			else
				throw new ArgumentException("Value should be of type TermSearchRowBasic", "basic");
		}
	}
}
