...
{
	public partial class ExpenseCategorySearchBasic : ISearchBasic, ISupportsCustomFields<SearchCustomField>	
	{			
		/// <summary>
	...
	public partial class ExpenseCategorySearch : ISearchRecord
	{
		/// <summary>
		...
		public ISearchBasic GetSearchBasic(bool create)
		{
			if (create && this.basic == null)
				this.basic = new ExpenseCategorySearchBasic();
			return this.basic;
		}
	}
}	
