...
{
	public partial class CustomerCategorySearchRow : ISearchRow
	{
		...
		{
			if (basic is CustomerCategorySearchRowBasic)
				this.basic = (CustomerCategorySearchRowBasic)basic;
			else
				throw new ArgumentException("Value should be of type CustomerCategorySearchRowBasic", "basic");
		}
	}
}
