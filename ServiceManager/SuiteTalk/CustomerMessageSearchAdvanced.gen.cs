...
{
	public partial class CustomerMessageSearchAdvanced : ISearchAdvanced
	{
		...
		{ 
			if (search is CustomerMessageSearch)
				this.criteria = (CustomerMessageSearch)search; 
			else
				throw new System.ArgumentException("Parameter should be of type CustomerMessageSearch", "search");
		}
		...
		public SearchRow GetColumns(bool create)
		{
			...
			{
				this.columns = new CustomerMessageSearchRow();
			}
			return this.columns;
		}
