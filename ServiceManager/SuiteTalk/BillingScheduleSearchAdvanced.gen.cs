...
{
	public partial class BillingScheduleSearchAdvanced : ISearchAdvanced
	{
		...
		{ 
			if (search is BillingScheduleSearch)
				this.criteria = (BillingScheduleSearch)search; 
			else
				throw new System.ArgumentException("Parameter should be of type BillingScheduleSearch", "search");
		}
		...
		public SearchRow GetColumns(bool create)
		{
			...
			{
				this.columns = new BillingScheduleSearchRow();
			}
			return this.columns;
		}
		...
		{ 
			if (columns is BillingScheduleSearchRow)
				this.columns = (BillingScheduleSearchRow)columns; 
			else
				throw new System.ArgumentException("Parameter should be of type BillingScheduleSearchRow", "columns");
		}
