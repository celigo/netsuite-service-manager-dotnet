...
{
	public partial class AppDefinitionSearchBasic : ISearchBasic	
	{	}

	public partial class AppDefinitionSearch : ISearchRecord
	{
		/// <summary>
		...
		public ISearchBasic GetSearchBasic(bool create)
		{
			if (create && this.basic == null)
				this.basic = new AppDefinitionSearchBasic();
			return this.basic;
		}
	}
}	
