...
{
	public partial class NexusSearchRow : ISearchRow
	{
		...
		{
			if (basic is NexusSearchRowBasic)
				this.basic = (NexusSearchRowBasic)basic;
			else
				throw new ArgumentException("Value should be of type NexusSearchRowBasic", "basic");
		}
	}
}
