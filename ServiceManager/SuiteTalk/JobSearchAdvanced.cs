...
{
	public partial class JobSearchAdvanced : ISearchAdvanced
	{
		...
		{ 
			if (search is JobSearch)
				this.criteria = (JobSearch)search; 
			else
				throw new System.ArgumentException("Parameter should be of type JobSearch", "search");
		}
		...
		{ 
			if (columns is JobSearchRow)
				this.columns = (JobSearchRow)columns; 
			else
				throw new System.ArgumentException("Parameter should be of type JobSearchRow", "columns");
		}
