...
{
	public partial class DepartmentSearchRow : ISearchRow
	{
		...
		{
			if (basic is DepartmentSearchRowBasic)
				this.basic = (DepartmentSearchRowBasic)basic;
			else
				throw new ArgumentException("Value should be of type DepartmentSearchRowBasic", "basic");
		}
	}
}
