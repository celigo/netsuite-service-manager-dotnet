...
{
	public partial class ItemRevisionSearchAdvanced : ISearchAdvanced
	{
		...
		{ 
			if (search is ItemRevisionSearch)
				this.criteria = (ItemRevisionSearch)search; 
			else
				throw new System.ArgumentException("Parameter should be of type ItemRevisionSearch", "search");
		}
		...
		public SearchRow GetColumns(bool create)
		{
			...
			{
				this.columns = new ItemRevisionSearchRow();
			}
			return this.columns;
		}
		...
		{ 
			if (columns is ItemRevisionSearchRow)
				this.columns = (ItemRevisionSearchRow)columns; 
			else
				throw new System.ArgumentException("Parameter should be of type ItemRevisionSearchRow", "columns");
		}
