...
{
	public partial class ItemDemandPlanSearchRow : ISearchRow
	{
		...
		{
			if (basic is ItemDemandPlanSearchRowBasic)
				this.basic = (ItemDemandPlanSearchRowBasic)basic;
			else
				throw new ArgumentException("Value should be of type ItemDemandPlanSearchRowBasic", "basic");
		}
	}
}
