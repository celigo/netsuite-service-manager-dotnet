...
{
	public partial class BinSearchAdvanced : ISearchAdvanced
	{
		...
		{ 
			if (search is BinSearch)
				this.criteria = (BinSearch)search; 
			else
				throw new System.ArgumentException("Parameter should be of type BinSearch", "search");
		}
		...
		{ 
			if (columns is BinSearchRow)
				this.columns = (BinSearchRow)columns; 
			else
				throw new System.ArgumentException("Parameter should be of type BinSearchRow", "columns");
		}
