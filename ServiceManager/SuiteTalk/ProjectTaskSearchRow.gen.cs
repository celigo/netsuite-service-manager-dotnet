...
{
	public partial class ProjectTaskSearchRow : ISearchRow
	{
		...
		{
			if (basic is ProjectTaskSearchRowBasic)
				this.basic = (ProjectTaskSearchRowBasic)basic;
			else
				throw new ArgumentException("Value should be of type ProjectTaskSearchRowBasic", "basic");
		}
	}
}
