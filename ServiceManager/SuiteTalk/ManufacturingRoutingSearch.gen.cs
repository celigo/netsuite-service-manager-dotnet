...
{
	public partial class ManufacturingRoutingSearchBasic : ISearchBasic, ISupportsCustomFields<SearchCustomField>	
	{			
		/// <summary>
	...
	public partial class ManufacturingRoutingSearch : ISearchRecord
	{
		/// <summary>
		...
		public ISearchBasic GetSearchBasic(bool create)
		{
			if (create && this.basic == null)
				this.basic = new ManufacturingRoutingSearchBasic();
			return this.basic;
		}
	}
}	
