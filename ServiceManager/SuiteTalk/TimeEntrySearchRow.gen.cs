...
{
	public partial class TimeEntrySearchRow : ISearchRow
	{
		...
		{
			if (basic is TimeEntrySearchRowBasic)
				this.basic = (TimeEntrySearchRowBasic)basic;
			else
				throw new ArgumentException("Value should be of type TimeEntrySearchRowBasic", "basic");
		}
	}
}
