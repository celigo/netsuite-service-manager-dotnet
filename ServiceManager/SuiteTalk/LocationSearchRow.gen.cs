...
{
	public partial class LocationSearchRow : ISearchRow
	{
		...
		{
			if (basic is LocationSearchRowBasic)
				this.basic = (LocationSearchRowBasic)basic;
			else
				throw new ArgumentException("Value should be of type LocationSearchRowBasic", "basic");
		}
	}
}
