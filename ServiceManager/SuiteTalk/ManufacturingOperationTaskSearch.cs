...
{
	public partial class ManufacturingOperationTaskSearchBasic : ISearchBasic, ISupportsCustomFields<SearchCustomField>	
	{			
		/// <summary>
	...
	public partial class ManufacturingOperationTaskSearch : ISearchRecord
	{
		/// <summary>
		...
		public ISearchBasic GetSearchBasic(bool create)
		{
			if (create && this.basic == null)
				this.basic = new ManufacturingOperationTaskSearchBasic();
			return this.basic;
		}
	}
}	
