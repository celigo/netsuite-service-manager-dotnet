...
{
	public partial class RevRecScheduleSearchAdvanced : ISearchAdvanced
	{
		...
		{ 
			if (search is RevRecScheduleSearch)
				this.criteria = (RevRecScheduleSearch)search; 
			else
				throw new System.ArgumentException("Parameter should be of type RevRecScheduleSearch", "search");
		}
		...
		public SearchRow GetColumns(bool create)
		{
			...
			{
				this.columns = new RevRecScheduleSearchRow();
			}
			return this.columns;
		}
