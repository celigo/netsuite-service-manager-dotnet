...
{
	public partial class SalesRoleSearchRow : ISearchRow
	{
		...
		{
			if (basic is SalesRoleSearchRowBasic)
				this.basic = (SalesRoleSearchRowBasic)basic;
			else
				throw new ArgumentException("Value should be of type SalesRoleSearchRowBasic", "basic");
		}
	}
}
