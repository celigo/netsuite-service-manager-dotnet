...
{
	public partial class ItemRevisionSearchRow : ISearchRow
	{
		...
		{
			if (basic is ItemRevisionSearchRowBasic)
				this.basic = (ItemRevisionSearchRowBasic)basic;
			else
				throw new ArgumentException("Value should be of type ItemRevisionSearchRowBasic", "basic");
		}
	}
}
