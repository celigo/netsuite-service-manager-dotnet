...
{
	public partial class CustomerStatusSearchRow : ISearchRow
	{
		...
		{
			if (basic is CustomerStatusSearchRowBasic)
				this.basic = (CustomerStatusSearchRowBasic)basic;
			else
				throw new ArgumentException("Value should be of type CustomerStatusSearchRowBasic", "basic");
		}
	}
}
