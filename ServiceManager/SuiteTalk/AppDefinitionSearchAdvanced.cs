...
{
	public partial class AppDefinitionSearchAdvanced : ISearchAdvanced
	{
		...
		public ISearchRecord GetCriteria(bool create)
		{
			...
			{
				this.criteria = new AppDefinitionSearch();
			}
		...
		{ 
			if (search is AppDefinitionSearch)
				this.criteria = (AppDefinitionSearch)search; 
			else
				throw new System.ArgumentException("Parameter should be of type AppDefinitionSearch", "search");
		}
		...
		public SearchRow GetColumns(bool create)
		{
			...
			{
				this.columns = new AppDefinitionSearchRow();
			}
			return this.columns;
		}
		...
		{ 
			if (columns is AppDefinitionSearchRow)
				this.columns = (AppDefinitionSearchRow)columns; 
			else
				throw new System.ArgumentException("Parameter should be of type AppDefinitionSearchRow", "columns");
		}
