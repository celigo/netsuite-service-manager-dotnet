...
{
	public partial class ManufacturingRoutingSearchAdvanced : ISearchAdvanced
	{
		...
		{ 
			if (search is ManufacturingRoutingSearch)
				this.criteria = (ManufacturingRoutingSearch)search; 
			else
				throw new System.ArgumentException("Parameter should be of type ManufacturingRoutingSearch", "search");
		}
		...
		public SearchRow GetColumns(bool create)
		{
			...
			{
				this.columns = new ManufacturingRoutingSearchRow();
			}
			return this.columns;
		}
		...
		{ 
			if (columns is ManufacturingRoutingSearchRow)
				this.columns = (ManufacturingRoutingSearchRow)columns; 
			else
				throw new System.ArgumentException("Parameter should be of type ManufacturingRoutingSearchRow", "columns");
		}
