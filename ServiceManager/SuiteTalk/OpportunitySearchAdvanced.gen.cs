...
{
	public partial class OpportunitySearchAdvanced : ISearchAdvanced
	{
		...
		{ 
			if (search is OpportunitySearch)
				this.criteria = (OpportunitySearch)search; 
			else
				throw new System.ArgumentException("Parameter should be of type OpportunitySearch", "search");
		}
		...
		public SearchRow GetColumns(bool create)
		{
			...
			{
				this.columns = new OpportunitySearchRow();
			}
			return this.columns;
		}
		...
		{ 
			if (columns is OpportunitySearchRow)
				this.columns = (OpportunitySearchRow)columns; 
			else
				throw new System.ArgumentException("Parameter should be of type OpportunitySearchRow", "columns");
		}
