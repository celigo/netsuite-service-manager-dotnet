...
{
	public partial class OriginatingLeadSearchBasic : ISearchBasic, ISupportsCustomFields<SearchCustomField>	
	{			
		/// <summary>
	...
	public partial class OriginatingLeadSearch : ISearchRecord
	{
		/// <summary>
		...
		public ISearchBasic GetSearchBasic(bool create)
		{
			if (create && this.basic == null)
				this.basic = new OriginatingLeadSearchBasic();
			return this.basic;
		}
	}
}	
