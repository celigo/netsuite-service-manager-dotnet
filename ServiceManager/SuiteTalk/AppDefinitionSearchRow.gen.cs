...
{
	public partial class AppDefinitionSearchRow : ISearchRow
	{
		...
		{
			if (basic is AppDefinitionSearchRowBasic)
				this.basic = (AppDefinitionSearchRowBasic)basic;
			else
				throw new ArgumentException("Value should be of type AppDefinitionSearchRowBasic", "basic");
		}
	}
}
