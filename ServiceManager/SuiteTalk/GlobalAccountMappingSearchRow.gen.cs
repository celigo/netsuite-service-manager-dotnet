...
{
	public partial class GlobalAccountMappingSearchRow : ISearchRow
	{
		...
		{
			if (basic is GlobalAccountMappingSearchRowBasic)
				this.basic = (GlobalAccountMappingSearchRowBasic)basic;
			else
				throw new ArgumentException("Value should be of type GlobalAccountMappingSearchRowBasic", "basic");
		}
	}
}
