...
{
	public partial class CalendarEventSearchAdvanced : ISearchAdvanced
	{
		...
		{ 
			if (search is CalendarEventSearch)
				this.criteria = (CalendarEventSearch)search; 
			else
				throw new System.ArgumentException("Parameter should be of type CalendarEventSearch", "search");
		}
		...
		public SearchRow GetColumns(bool create)
		{
			...
			{
				this.columns = new CalendarEventSearchRow();
			}
			return this.columns;
		}
		...
		{ 
			if (columns is CalendarEventSearchRow)
				this.columns = (CalendarEventSearchRow)columns; 
			else
				throw new System.ArgumentException("Parameter should be of type CalendarEventSearchRow", "columns");
		}
