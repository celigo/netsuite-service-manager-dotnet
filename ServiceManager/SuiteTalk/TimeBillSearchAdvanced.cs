...
{
	public partial class TimeBillSearchAdvanced : ISearchAdvanced
	{
		...
		{ 
			if (search is TimeBillSearch)
				this.criteria = (TimeBillSearch)search; 
			else
				throw new System.ArgumentException("Parameter should be of type TimeBillSearch", "search");
		}
		...
		public SearchRow GetColumns(bool create)
		{
			...
			{
				this.columns = new TimeBillSearchRow();
			}
			return this.columns;
		}
		...
		{ 
			if (columns is TimeBillSearchRow)
				this.columns = (TimeBillSearchRow)columns; 
			else
				throw new System.ArgumentException("Parameter should be of type TimeBillSearchRow", "columns");
		}
