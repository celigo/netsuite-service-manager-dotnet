...
{
	public partial class ClassificationSearchRow : ISearchRow
	{
		...
		{
			if (basic is ClassificationSearchRowBasic)
				this.basic = (ClassificationSearchRowBasic)basic;
			else
				throw new ArgumentException("Value should be of type ClassificationSearchRowBasic", "basic");
		}
	}
}
