...
{
	public partial class SubsidiarySearchRow : ISearchRow
	{
		...
		{
			if (basic is SubsidiarySearchRowBasic)
				this.basic = (SubsidiarySearchRowBasic)basic;
			else
				throw new ArgumentException("Value should be of type SubsidiarySearchRowBasic", "basic");
		}
	}
}
