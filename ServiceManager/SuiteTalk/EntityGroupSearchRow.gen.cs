...
{
	public partial class EntityGroupSearchRow : ISearchRow
	{
		...
		{
			if (basic is EntityGroupSearchRowBasic)
				this.basic = (EntityGroupSearchRowBasic)basic;
			else
				throw new ArgumentException("Value should be of type EntityGroupSearchRowBasic", "basic");
		}
	}
}
