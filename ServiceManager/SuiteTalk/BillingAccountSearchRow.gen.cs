...
{
	public partial class BillingAccountSearchRow : ISearchRow
	{
		...
		{
			if (basic is BillingAccountSearchRowBasic)
				this.basic = (BillingAccountSearchRowBasic)basic;
			else
				throw new ArgumentException("Value should be of type BillingAccountSearchRowBasic", "basic");
		}
	}
}
