...
{
	public partial class SolutionSearchRow : ISearchRow
	{
		...
		{
			if (basic is SolutionSearchRowBasic)
				this.basic = (SolutionSearchRowBasic)basic;
			else
				throw new ArgumentException("Value should be of type SolutionSearchRowBasic", "basic");
		}
	}
}
