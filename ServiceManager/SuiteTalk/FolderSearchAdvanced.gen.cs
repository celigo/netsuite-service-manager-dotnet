...
{
	public partial class FolderSearchAdvanced : ISearchAdvanced
	{
		...
		public SearchRow GetColumns(bool create)
		{
			...
			{
				this.columns = new FolderSearchRow();
			}
			return this.columns;
		}
		...
		{ 
			if (columns is FolderSearchRow)
				this.columns = (FolderSearchRow)columns; 
			else
				throw new System.ArgumentException("Parameter should be of type FolderSearchRow", "columns");
		}
