...
{
	public partial class BillingScheduleSearchBasic : ISearchBasic	
	{	}

	public partial class BillingScheduleSearch : ISearchRecord
	{
		/// <summary>
		...
		public ISearchBasic GetSearchBasic(bool create)
		{
			if (create && this.basic == null)
				this.basic = new BillingScheduleSearchBasic();
			return this.basic;
		}
	}
}	
