...
{
	public partial class RevRecTemplateSearchAdvanced : ISearchAdvanced
	{
		...
		{ 
			if (search is RevRecTemplateSearch)
				this.criteria = (RevRecTemplateSearch)search; 
			else
				throw new System.ArgumentException("Parameter should be of type RevRecTemplateSearch", "search");
		}
		...
		public SearchRow GetColumns(bool create)
		{
			...
			{
				this.columns = new RevRecTemplateSearchRow();
			}
			return this.columns;
		}
		...
		{ 
			if (columns is RevRecTemplateSearchRow)
				this.columns = (RevRecTemplateSearchRow)columns; 
			else
				throw new System.ArgumentException("Parameter should be of type RevRecTemplateSearchRow", "columns");
		}
