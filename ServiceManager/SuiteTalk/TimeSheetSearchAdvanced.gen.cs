...
{
	public partial class TimeSheetSearchAdvanced : ISearchAdvanced
	{
		...
		{ 
			if (search is TimeSheetSearch)
				this.criteria = (TimeSheetSearch)search; 
			else
				throw new System.ArgumentException("Parameter should be of type TimeSheetSearch", "search");
		}
		...
		public SearchRow GetColumns(bool create)
		{
			...
			{
				this.columns = new TimeSheetSearchRow();
			}
			return this.columns;
		}
		...
		{ 
			if (columns is TimeSheetSearchRow)
				this.columns = (TimeSheetSearchRow)columns; 
			else
				throw new System.ArgumentException("Parameter should be of type TimeSheetSearchRow", "columns");
		}
