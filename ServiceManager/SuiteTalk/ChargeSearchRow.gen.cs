...
{
	public partial class ChargeSearchRow : ISearchRow
	{
		...
		{
			if (basic is ChargeSearchRowBasic)
				this.basic = (ChargeSearchRowBasic)basic;
			else
				throw new ArgumentException("Value should be of type ChargeSearchRowBasic", "basic");
		}
	}
}
