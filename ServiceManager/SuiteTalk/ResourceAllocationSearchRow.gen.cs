...
{
	public partial class ResourceAllocationSearchRow : ISearchRow
	{
		...
		{
			if (basic is ResourceAllocationSearchRowBasic)
				this.basic = (ResourceAllocationSearchRowBasic)basic;
			else
				throw new ArgumentException("Value should be of type ResourceAllocationSearchRowBasic", "basic");
		}
	}
}
