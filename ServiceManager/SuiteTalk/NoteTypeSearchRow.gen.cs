...
{
	public partial class NoteTypeSearchRow : ISearchRow
	{
		...
		{
			if (basic is NoteTypeSearchRowBasic)
				this.basic = (NoteTypeSearchRowBasic)basic;
			else
				throw new ArgumentException("Value should be of type NoteTypeSearchRowBasic", "basic");
		}
	}
}
