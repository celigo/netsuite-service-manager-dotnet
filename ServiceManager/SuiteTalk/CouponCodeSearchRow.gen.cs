...
{
	public partial class CouponCodeSearchRow : ISearchRow
	{
		...
		{
			if (basic is CouponCodeSearchRowBasic)
				this.basic = (CouponCodeSearchRowBasic)basic;
			else
				throw new ArgumentException("Value should be of type CouponCodeSearchRowBasic", "basic");
		}
	}
}
