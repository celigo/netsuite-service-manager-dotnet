...
{
	public partial class NoteSearchBasic : ISearchBasic, ISupportsCustomFields<SearchCustomField>	
	{			
		/// <summary>
	...
	public partial class NoteSearch : ISearchRecord
	{
		/// <summary>
		...
		public ISearchBasic GetSearchBasic(bool create)
		{
			if (create && this.basic == null)
				this.basic = new NoteSearchBasic();
			return this.basic;
		}
	}
}	
