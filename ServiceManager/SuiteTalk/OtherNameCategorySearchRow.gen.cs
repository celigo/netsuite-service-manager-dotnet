...
{
	public partial class OtherNameCategorySearchRow : ISearchRow
	{
		...
		{
			if (basic is OtherNameCategorySearchRowBasic)
				this.basic = (OtherNameCategorySearchRowBasic)basic;
			else
				throw new ArgumentException("Value should be of type OtherNameCategorySearchRowBasic", "basic");
		}
	}
}
