...
{
	public partial class CustomerSearchAdvanced : ISearchAdvanced
	{
		...
		{ 
			if (search is CustomerSearch)
				this.criteria = (CustomerSearch)search; 
			else
				throw new System.ArgumentException("Parameter should be of type CustomerSearch", "search");
		}
		...
		public SearchRow GetColumns(bool create)
		{
			...
			{
				this.columns = new CustomerSearchRow();
			}
			return this.columns;
		}
		...
		{ 
			if (columns is CustomerSearchRow)
				this.columns = (CustomerSearchRow)columns; 
			else
				throw new System.ArgumentException("Parameter should be of type CustomerSearchRow", "columns");
		}
