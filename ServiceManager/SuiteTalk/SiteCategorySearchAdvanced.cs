...
{
	public partial class SiteCategorySearchAdvanced : ISearchAdvanced
	{
		...
		{ 
			if (search is SiteCategorySearch)
				this.criteria = (SiteCategorySearch)search; 
			else
				throw new System.ArgumentException("Parameter should be of type SiteCategorySearch", "search");
		}
		...
		public SearchRow GetColumns(bool create)
		{
			...
			{
				this.columns = new SiteCategorySearchRow();
			}
			return this.columns;
		}
		...
		{ 
			if (columns is SiteCategorySearchRow)
				this.columns = (SiteCategorySearchRow)columns; 
			else
				throw new System.ArgumentException("Parameter should be of type SiteCategorySearchRow", "columns");
		}
