...
{
	public partial class NoteTypeSearchAdvanced : ISearchAdvanced
	{
		...
		{ 
			if (search is NoteTypeSearch)
				this.criteria = (NoteTypeSearch)search; 
			else
				throw new System.ArgumentException("Parameter should be of type NoteTypeSearch", "search");
		}
		...
		public SearchRow GetColumns(bool create)
		{
			...
			{
				this.columns = new NoteTypeSearchRow();
			}
			return this.columns;
		}
		...
		{ 
			if (columns is NoteTypeSearchRow)
				this.columns = (NoteTypeSearchRow)columns; 
			else
				throw new System.ArgumentException("Parameter should be of type NoteTypeSearchRow", "columns");
		}
