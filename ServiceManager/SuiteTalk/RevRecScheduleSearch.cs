...
{
	public partial class RevRecScheduleSearchBasic : ISearchBasic	
	{	}

	public partial class RevRecScheduleSearch : ISearchRecord
	{
		/// <summary>
		...
		public ISearchBasic GetSearchBasic(bool create)
		{
			if (create && this.basic == null)
				this.basic = new RevRecScheduleSearchBasic();
			return this.basic;
		}
	}
}	
