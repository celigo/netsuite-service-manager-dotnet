...
{
	public partial class PromotionCodeSearchAdvanced : ISearchAdvanced
	{
		...
		{ 
			if (search is PromotionCodeSearch)
				this.criteria = (PromotionCodeSearch)search; 
			else
				throw new System.ArgumentException("Parameter should be of type PromotionCodeSearch", "search");
		}
		...
		public SearchRow GetColumns(bool create)
		{
			...
			{
				this.columns = new PromotionCodeSearchRow();
			}
			return this.columns;
		}
		...
		{ 
			if (columns is PromotionCodeSearchRow)
				this.columns = (PromotionCodeSearchRow)columns; 
			else
				throw new System.ArgumentException("Parameter should be of type PromotionCodeSearchRow", "columns");
		}
