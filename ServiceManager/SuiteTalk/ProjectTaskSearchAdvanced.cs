...
{
	public partial class ProjectTaskSearchAdvanced : ISearchAdvanced
	{
		...
		{ 
			if (search is ProjectTaskSearch)
				this.criteria = (ProjectTaskSearch)search; 
			else
				throw new System.ArgumentException("Parameter should be of type ProjectTaskSearch", "search");
		}
		...
		public SearchRow GetColumns(bool create)
		{
			...
			{
				this.columns = new ProjectTaskSearchRow();
			}
			return this.columns;
		}
		...
		{ 
			if (columns is ProjectTaskSearchRow)
				this.columns = (ProjectTaskSearchRow)columns; 
			else
				throw new System.ArgumentException("Parameter should be of type ProjectTaskSearchRow", "columns");
		}
