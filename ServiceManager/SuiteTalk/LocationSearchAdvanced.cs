...
{
	public partial class LocationSearchAdvanced : ISearchAdvanced
	{
		...
		{ 
			if (search is LocationSearch)
				this.criteria = (LocationSearch)search; 
			else
				throw new System.ArgumentException("Parameter should be of type LocationSearch", "search");
		}
		...
		public SearchRow GetColumns(bool create)
		{
			...
			{
				this.columns = new LocationSearchRow();
			}
			return this.columns;
		}
		...
		{ 
			if (columns is LocationSearchRow)
				this.columns = (LocationSearchRow)columns; 
			else
				throw new System.ArgumentException("Parameter should be of type LocationSearchRow", "columns");
		}
