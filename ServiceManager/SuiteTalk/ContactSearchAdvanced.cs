...
{
	public partial class ContactSearchAdvanced : ISearchAdvanced
	{
		...
		{ 
			if (search is ContactSearch)
				this.criteria = (ContactSearch)search; 
			else
				throw new System.ArgumentException("Parameter should be of type ContactSearch", "search");
		}
		...
		public SearchRow GetColumns(bool create)
		{
			...
			{
				this.columns = new ContactSearchRow();
			}
			return this.columns;
		}
		...
		{ 
			if (columns is ContactSearchRow)
				this.columns = (ContactSearchRow)columns; 
			else
				throw new System.ArgumentException("Parameter should be of type ContactSearchRow", "columns");
		}
