...
{
	public partial class CouponCodeSearchAdvanced : ISearchAdvanced
	{
		...
		{ 
			if (search is CouponCodeSearch)
				this.criteria = (CouponCodeSearch)search; 
			else
				throw new System.ArgumentException("Parameter should be of type CouponCodeSearch", "search");
		}
		...
		public SearchRow GetColumns(bool create)
		{
			...
			{
				this.columns = new CouponCodeSearchRow();
			}
			return this.columns;
		}
		...
		{ 
			if (columns is CouponCodeSearchRow)
				this.columns = (CouponCodeSearchRow)columns; 
			else
				throw new System.ArgumentException("Parameter should be of type CouponCodeSearchRow", "columns");
		}
