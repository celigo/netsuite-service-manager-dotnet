...
{
	public partial class CustomRecordSearchRow : ISearchRow
	{
		...
		{
			if (basic is CustomRecordSearchRowBasic)
				this.basic = (CustomRecordSearchRowBasic)basic;
			else
				throw new ArgumentException("Value should be of type CustomRecordSearchRowBasic", "basic");
		}
	}
}
