...
{
	public partial class AppPackageSearchAdvanced : ISearchAdvanced
	{
		...
		public ISearchRecord GetCriteria(bool create)
		{
			...
			{
				this.criteria = new AppPackageSearch();
			}
		...
		{ 
			if (search is AppPackageSearch)
				this.criteria = (AppPackageSearch)search; 
			else
				throw new System.ArgumentException("Parameter should be of type AppPackageSearch", "search");
		}
		...
		public SearchRow GetColumns(bool create)
		{
			...
			{
				this.columns = new AppPackageSearchRow();
			}
			return this.columns;
		}
		...
		{ 
			if (columns is AppPackageSearchRow)
				this.columns = (AppPackageSearchRow)columns; 
			else
				throw new System.ArgumentException("Parameter should be of type AppPackageSearchRow", "columns");
		}
