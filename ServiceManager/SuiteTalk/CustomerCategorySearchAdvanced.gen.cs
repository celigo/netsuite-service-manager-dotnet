...
{
	public partial class CustomerCategorySearchAdvanced : ISearchAdvanced
	{
		...
		{ 
			if (search is CustomerCategorySearch)
				this.criteria = (CustomerCategorySearch)search; 
			else
				throw new System.ArgumentException("Parameter should be of type CustomerCategorySearch", "search");
		}
		...
		public SearchRow GetColumns(bool create)
		{
			...
			{
				this.columns = new CustomerCategorySearchRow();
			}
			return this.columns;
		}
		...
		{ 
			if (columns is CustomerCategorySearchRow)
				this.columns = (CustomerCategorySearchRow)columns; 
			else
				throw new System.ArgumentException("Parameter should be of type CustomerCategorySearchRow", "columns");
		}
