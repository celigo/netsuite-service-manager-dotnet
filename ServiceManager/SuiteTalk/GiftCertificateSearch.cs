...
{
	public partial class GiftCertificateSearchBasic : ISearchBasic, ISupportsCustomFields<SearchCustomField>	
	{			
		/// <summary>
	...
	public partial class GiftCertificateSearch : ISearchRecord
	{
		/// <summary>
		...
		public ISearchBasic GetSearchBasic(bool create)
		{
			if (create && this.basic == null)
				this.basic = new GiftCertificateSearchBasic();
			return this.basic;
		}
	}
}	
