...
{
	public partial class SolutionSearchAdvanced : ISearchAdvanced
	{
		...
		{ 
			if (search is SolutionSearch)
				this.criteria = (SolutionSearch)search; 
			else
				throw new System.ArgumentException("Parameter should be of type SolutionSearch", "search");
		}
		...
		public SearchRow GetColumns(bool create)
		{
			...
			{
				this.columns = new SolutionSearchRow();
			}
			return this.columns;
		}
		...
		{ 
			if (columns is SolutionSearchRow)
				this.columns = (SolutionSearchRow)columns; 
			else
				throw new System.ArgumentException("Parameter should be of type SolutionSearchRow", "columns");
		}
