...
{
	public partial class TimeSheetSearchRow : ISearchRow
	{
		...
		{
			if (basic is TimeSheetSearchRowBasic)
				this.basic = (TimeSheetSearchRowBasic)basic;
			else
				throw new ArgumentException("Value should be of type TimeSheetSearchRowBasic", "basic");
		}
	}
}
