...
{
	public partial class JobStatusSearchAdvanced : ISearchAdvanced
	{
		...
		{ 
			if (search is JobStatusSearch)
				this.criteria = (JobStatusSearch)search; 
			else
				throw new System.ArgumentException("Parameter should be of type JobStatusSearch", "search");
		}
		...
		public SearchRow GetColumns(bool create)
		{
			...
			{
				this.columns = new JobStatusSearchRow();
			}
			return this.columns;
		}
		...
		{ 
			if (columns is JobStatusSearchRow)
				this.columns = (JobStatusSearchRow)columns; 
			else
				throw new System.ArgumentException("Parameter should be of type JobStatusSearchRow", "columns");
		}
