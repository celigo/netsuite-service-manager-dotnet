...
{
	public partial class RevRecScheduleSearchRow : ISearchRow
	{
		...
		{
			if (basic is RevRecScheduleSearchRowBasic)
				this.basic = (RevRecScheduleSearchRowBasic)basic;
			else
				throw new ArgumentException("Value should be of type RevRecScheduleSearchRowBasic", "basic");
		}
	}
}
