...
{
	public partial class VendorCategorySearchBasic : ISearchBasic	
	{	}

	public partial class VendorCategorySearch : ISearchRecord
	{
		/// <summary>
		...
		public ISearchBasic GetSearchBasic(bool create)
		{
			if (create && this.basic == null)
				this.basic = new VendorCategorySearchBasic();
			return this.basic;
		}
	}
}	
