...
{
	public partial class JobTypeSearchRow : ISearchRow
	{
		...
		{
			if (basic is JobTypeSearchRowBasic)
				this.basic = (JobTypeSearchRowBasic)basic;
			else
				throw new ArgumentException("Value should be of type JobTypeSearchRowBasic", "basic");
		}
	}
}
