...
{
	public partial class ItemSupplyPlanSearchBasic : ISearchBasic, ISupportsCustomFields<SearchCustomField>	
	{			
		/// <summary>
	...
	public partial class ItemSupplyPlanSearch : ISearchRecord
	{
		/// <summary>
		...
		public ISearchBasic GetSearchBasic(bool create)
		{
			if (create && this.basic == null)
				this.basic = new ItemSupplyPlanSearchBasic();
			return this.basic;
		}
	}
}	
