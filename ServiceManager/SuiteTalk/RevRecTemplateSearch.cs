...
{
	public partial class RevRecTemplateSearchBasic : ISearchBasic	
	{	}

	public partial class RevRecTemplateSearch : ISearchRecord
	{
		/// <summary>
		...
		public ISearchBasic GetSearchBasic(bool create)
		{
			if (create && this.basic == null)
				this.basic = new RevRecTemplateSearchBasic();
			return this.basic;
		}
	}
}	
