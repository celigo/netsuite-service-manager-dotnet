...
{
	public partial class ExpenseCategorySearchAdvanced : ISearchAdvanced
	{
		...
		{ 
			if (search is ExpenseCategorySearch)
				this.criteria = (ExpenseCategorySearch)search; 
			else
				throw new System.ArgumentException("Parameter should be of type ExpenseCategorySearch", "search");
		}
		...
		public SearchRow GetColumns(bool create)
		{
			...
			{
				this.columns = new ExpenseCategorySearchRow();
			}
			return this.columns;
		}
