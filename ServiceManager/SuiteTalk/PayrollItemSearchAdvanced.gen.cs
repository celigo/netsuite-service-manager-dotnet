...
{
	public partial class PayrollItemSearchAdvanced : ISearchAdvanced
	{
		...
		{ 
			if (search is PayrollItemSearch)
				this.criteria = (PayrollItemSearch)search; 
			else
				throw new System.ArgumentException("Parameter should be of type PayrollItemSearch", "search");
		}
		...
		public SearchRow GetColumns(bool create)
		{
			...
			{
				this.columns = new PayrollItemSearchRow();
			}
			return this.columns;
		}
		...
		{ 
			if (columns is PayrollItemSearchRow)
				this.columns = (PayrollItemSearchRow)columns; 
			else
				throw new System.ArgumentException("Parameter should be of type PayrollItemSearchRow", "columns");
		}
