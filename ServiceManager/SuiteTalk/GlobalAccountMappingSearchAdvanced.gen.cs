...
{
	public partial class GlobalAccountMappingSearchAdvanced : ISearchAdvanced
	{
		...
		{ 
			if (search is GlobalAccountMappingSearch)
				this.criteria = (GlobalAccountMappingSearch)search; 
			else
				throw new System.ArgumentException("Parameter should be of type GlobalAccountMappingSearch", "search");
		}
		...
		public SearchRow GetColumns(bool create)
		{
			...
			{
				this.columns = new GlobalAccountMappingSearchRow();
			}
			return this.columns;
		}
		...
		{ 
			if (columns is GlobalAccountMappingSearchRow)
				this.columns = (GlobalAccountMappingSearchRow)columns; 
			else
				throw new System.ArgumentException("Parameter should be of type GlobalAccountMappingSearchRow", "columns");
		}
